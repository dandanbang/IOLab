...
var cat2 = {
	alt: "Roxanne",
	src: "http://www.our-happy-cat.com/images/cat-drinking-from-tap.jpg"
}
...
function populateFromObj() {
	...
	for (var i = 0; i < catlist.length; i++) {
		...
		newImg.setAttribute('src',catlist[i].src);
		newImg.setAttribute('alt',catlist[i].alt);
		//console.log(newImg);

		newDiv.appendChild(newImg);
		var caption = document.createElement('p');
		caption.innerHTML = catlist[i].alt;
